...
#################################################################################
#######                                                                   #######
#######     ANALYTICAL TOMOGRAPHIC RECONSTRUCTION WITH GRIDDING METHOD    #######
#######                                                                   #######
...
import utils
import lhsf_module as lhsf
import extrapolation_module as extrap
...
def getArgs():
    parser = argparse.ArgumentParser(description='Analytical tomographic reconstruction through gridding',
    ...
    parser.add_argument('-a',dest='anti_alias',
                        help = 'Double the number of views through: ' 
                        + 'cubic  --->  cubic interpolation'
                        + 'telea  --->  Telea inpainting'
                        + 'lhsf  --->  Helgason-Ludwig sinogram filter')    
...
def main():
    ...
    if args.anti_alias is not None:
        if args.anti_alias == 'hlsf' or args.anti_alias == 'lhsf':
            ...
            print( '\nWarning: anti-aliasing method ', args.anti_alias, ' not found!' )
